/**
 * $Id: Utils.java,v 1.6 2004/10/20 11:47:36 krunte Exp $
 *
...
public class Utils {
     ...
     */
    public static byte[] floatListToByteArray(List floatList, boolean bigEndian) {
    ...
    public static List byteArrayToFloatList(byte[] raw, boolean bigEndian) {
