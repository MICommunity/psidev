 ...
 * Schema.
 * $Id: RangeDescriptor.java,v 1.1 2003/08/11 17:30:00 krunte Exp $
 */
...
public class RangeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RangeDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                if(!target.hasEnd())
                    return null;
                return new Integer(target.getEnd());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setEnd( ((Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- org.psi.ms.model.RangeDescriptor()
    ...
    {
        return org.psi.ms.model.Range.class;
